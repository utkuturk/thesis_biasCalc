...
p_avg_resp_towardsUng +theme(legend.position="none") + facet_wrap(~bias) | p_avg_resp_towardsG + ylab("") + theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) + facet_wrap(~bias)
```
